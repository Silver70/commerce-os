/**
 * ◄ TEMPLATE KNOB — countries offered in the checkout country selector.
 *
 * The canonical ISO 3166-1 alpha-2 list (officially-assigned codes). Trim this
 * to just the countries the store ships to for a shorter dropdown. The `code`
 * is what the backend shipping/zone lookup expects; `name` is the display label.
 */
