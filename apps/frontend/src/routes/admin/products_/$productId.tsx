...
const SEED_PRODUCT: ProductDetail = {
  ...
  images: [
    ...
    },
    {
      ...
      alt: "Back view — Navy",
      gradient:
        "from-blue-100 to-blue-200 dark:from-blue-950/60 dark:to-blue-900/60",
    },
    {
      id: "4",
      alt: "Detail — collar & cuff",
      gradient:
        "from-violet-100 to-violet-200 dark:from-violet-950/50 dark:to-violet-900/50",
    },
  ],
...
function ProductDetailPage() {
  ...
  const avgCost = Math.round(
    product.variants.reduce((s, v) => s + v.cost, 0) / product.variants.length,
  );
